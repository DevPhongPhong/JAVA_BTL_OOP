...
public class SectorController {
	...
	@CrossOrigin(origins = "http://127.0.0.1:5500/")
	@DeleteMapping("/delete/{sectorCode}")
	public ResponseEntity deleteCourse(@PathVariable(name = "sectorCode") String sectorCode) {
		int res = sectorService.delete(sectorCode);
